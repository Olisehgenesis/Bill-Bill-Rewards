  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="px-8 py-6 mt-4 text-left bg-white shadow-lg">
        <h3 className="text-2xl font-bold text-center">Register for BillBuddy Rewards</h3>
          ...
          <div className="mt-4">
            ...
            <div className="mt-4">
              <label className="inline-flex items-center">
                ...
                />
                <span className="ml-2">Register as Shopper</span>
              </label>
            </div>
            <div className="mt-4">
              <label className="inline-flex items-center">
                ...
                />
                <span className="ml-2">Register as Business Owner</span>
              </label>
            </div>
